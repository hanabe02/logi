...
//         System.out.println("넘어왔나?"+workplaceCode);
	...
	@Override
	public ArrayList<EmployeeMenuTO> login(String email, String password, String authority) {
		HashMap<String, String> map = new HashMap<>();
		...
		System.out.println("정상적으로 실행 됨 ");
		ArrayList<EmployeeMenuTO> list = empMapper.selectlogin(map);
	...
	@Override
	public ArrayList<CodeDetailTO> getVehicles(){
		System.out.println("\n" + "디버깅 포인트 2" + "\n");
		...
		System.out.println("\n" + "디버깅 포인트 3" + "\n");
		ArrayList<CodeDetailTO> vehicleList = codeMapper.selectVehiclesList(a);
		System.out.println("\n" + "디버깅 포인트 4" + "\n");
