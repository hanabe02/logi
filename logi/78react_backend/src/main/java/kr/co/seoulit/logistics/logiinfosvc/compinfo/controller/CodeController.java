...
//   }
	...
	@RequestMapping(value="/codedetail/driver" , method=RequestMethod.GET)
	public ModelMap searchContractDetail(){
		map = new ModelMap();

		try {
			ArrayList<CodeDetailTO> detailCodeList = compInfoService.getVehicles();
