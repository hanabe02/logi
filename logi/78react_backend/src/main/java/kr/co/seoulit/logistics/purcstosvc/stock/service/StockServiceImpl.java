...
//        String orderNoListJson = String.join(",", orderNoList);
//
//        HashMap<String, String> param = new HashMap<>();
//        param.put("orderNoList", orderNoListJson); // JSON 문자열로 추가
//        System.out.println("\nJSON 형태의 orderNoList: " + orderNoListJson + "\n");
//
//        stockMapper.inspection(param); // Mapper 호출
        HashMap<String, String> param = new HashMap<>();
        System.out.println("\n"+orderNoList+"\n");
