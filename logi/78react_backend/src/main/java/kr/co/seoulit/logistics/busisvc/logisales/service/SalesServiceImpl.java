...
import kr.co.seoulit.logistics.busisvc.logisales.mapper.ReleaseMapper;
import kr.co.seoulit.logistics.busisvc.logisales.to.ReleaseInfoTO;
...
//	}
	...
	@Override
	public ArrayList<ReleaseInfoTO> getReleaseInfoList() {

		ArrayList<ReleaseInfoTO> deliveryInfoList = null;

		deliveryInfoList = deliveryMapper.selectReleaseInfoList();
	...
	@Override
	public ModelMap release(String contractDetailNo, String transportMethod){
		ModelMap resultMap = new ModelMap();
		HashMap<String, Object> map = new HashMap<String, Object>();

		map.put("contractDetailNo", contractDetailNo);
		map.put("transportMethod", transportMethod);


		releaseMapper.release(map);
